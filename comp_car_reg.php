...
<!------------------------start of header------------------------------------------------------------>
 ...
 <form action="includes/car.php" method="post">
 <table width="91%" border="0" cellpadding="5">
  <tr>
    <td width="27%">plate number</td>
    <td width="73%"><input type="number"name="plate_number" size="25" required/></td>
    
  </tr>
  <tr>
    <td>car model</td>
    <td><input type="text"name="model" size="25" required/></td>
    
  </tr>
  <tr>
    <td>capacity</td>
    <td><input type="number"name="capacity" size="8" required/>
  ...
  <tr>
    ...
    <td><input type="text"name="operation_area" size="25" required /></td>
  ...
  <tr>
    <td>hourly price</td>
    <td><input type="text"name="hour" size="25" required /></td>
    
  </tr>
  <tr>
    <td>daily price</td>
    <td><input type="text"name="day" size="25" required /></td>
